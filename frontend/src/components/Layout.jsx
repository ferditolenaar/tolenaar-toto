      ...
      <nav className="navbar">
        ...
        <div className="container-centered nav-inner">
          ...
          <div className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            {isLoggedIn && (
              <>
                <NavLink to="/voorspellen" className={({ isActive }) => isActive ? 'nav-item active voorspel' : 'nav-item voorspel'}><span className="voorspel">Voorspellen</span>Wedstrijden</NavLink>
                <NavLink to="/top4" className={({ isActive }) => isActive ? 'nav-item active voorspel' : 'nav-item voorspel'}><span className="voorspel">Voorspellen</span>Top 4</NavLink>
              </>
            )}
