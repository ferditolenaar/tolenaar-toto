...
import { computePrizeMap } from '../lib/prizes';
            ...
            <div className="leaderboard-card">
                                    ...
                                    <td className="name-cell">
                                        <div className="player-info-stack">
                                            <span className="player-full-name">
                                                ...
                                                <PrizeBadges prizeMap={prizeMap} userId={user.id} />
                                            </span>
                ...
                <div className="leaderboard-legend">
                    <div className="legend-row">
                        <span className="legend-item"><span className="prize-icon prize-cup-gold">🏆</span> 1e plek totaal</span>
